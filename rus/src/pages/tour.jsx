      ...
      <div className="w-full max-w-[1920px] flex flex-col px-4 md:px-[160px] relative">
        <div className="flex flex-col lg:flex-row lg:justify-between items-start relative">
          <div className="w-full lg:max-w-[1000px] flex flex-col z-10">
            ...
            >
              <p>
                Мы верим, что премиальные масла и здоровое питание - это только
                начало. Наша настоящая цель - изменение жизни через изменение
                сознания.
              </p>
              <p>
                Поэтому мы создали инновационный подход, где сила продукта
                встречается с силой мысли. Мы строим комьюнити не вокруг
                покупок, а вокруг ценностей: осознанности, гармонии с природой и
                стремления к лучшей версии себя.
              </p>
              <p>
                С нами выгодно вдвойне: вы получаете не только эталонное
                качество с Алтая, но и возможность выиграть путешествие, которое
                перевернет ваш внутренний мир.
              </p>
            </div>
          </div>
        ...
        >
          ...
          >
            <div className="flex gap-2">
              ...
              <p>
                На каждой бутылке масла Злата Русь висит уникальная мудрая
                карточка с цитатой-размышлением.
              </p>
            </div>
            <div className="flex gap-2">
              <span className="flex-shrink-0 w-[20px]">2.</span>
              <p>
                Всего 8 золотых карточек (особого дизайна). Они — главные ключи.
              </p>
            </div>
            <div className="flex gap-2">
              <span className="flex-shrink-0 w-[20px]">3.</span>
              <p>
                Ваша задача: собрать все 56 карточек с одной золотой карточкой
            ...
            <div className="flex gap-2">
              ...
              <p>
                Как только коллекция из мудрыых карточек собрана — вы фиксируете
                их на фото на фоне бутылок Злата Русь, которые вы купили.
              </p>
            </div>
            <div className="flex gap-2">
              <span className="flex-shrink-0 w-[20px]">5.</span>
              <p>
                Отправляете фото на проверку в наш Telegram-бот
                (@ZlataAltaibot).
              </p>
            </div>
            <div className="flex gap-2">
              ...
              <p>
                После проверки модераторами (мы должны убедиться в подлинности
                карточек) — вы и ваш спутник получаете бесплатные путевки на
                10-дневный трансформационный тур в Алтай!
              </p>
            </div>
          </div>
        </div>
              ...
              {carouselImages.map((img, i) => {
                ...
                return (
                  <div
                    key={i}
                    onClick={() =>
                      !isActive && !isTransitioning && setActiveIndex(i)
                    }
                    ...
                    >
                      <img
                        ...
                        className={`w-full h-full object-contain select-none transition-all duration-500 ${
                          isActive
                            ? "scale-110 drop-shadow-[0_0_15px_rgba(255,209,112,0.8)]"
                            : ""
                        }`}
                        draggable={false}
                      />
